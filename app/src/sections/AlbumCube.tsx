  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-12 left-12 z-20">
        ...
        <p className="font-mono-custom text-sm text-white/50 mb-4">
          {currentAlbum.subtitle}
        </p>
        <button
          onClick={() => navigate('/topic-collection')}
          className="group flex items-center gap-2 px-5 py-2.5 bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/40 rounded-full text-cyan-400 text-sm font-medium transition-all"
        >
          进入学习
